...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients)
        ...
        clients.inMemory()
        .withClient("password")
        .authorizedGrantTypes("authorization_code","implicit","password","client_credentials", "refresh_token") //授权模式为password和refresh_token两种
        ...
        .redirectUris("https://www.baidu.com/"); //123加密后的密码
    }
